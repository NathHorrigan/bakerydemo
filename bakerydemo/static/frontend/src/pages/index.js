                    ...
                    <div key={node.id}>
                        ...
                        <div className={[styles.container, styles.homeColumns].join(' ')}>
                            <div className={styles.homeCtaBlock}>
                                <img alt="" className={styles.homeCtaBlockImage} src={getMediaUrl(node.promoImage.file.thumbnail)} />
                            ...
                            <div>
                                ...
                                <Link to="/breads/anadama-bread/" className={styles.homeBreadCard}>
                                    <img alt="" className={styles.homeBreadCardImage} src={getMediaUrl('/media/images/Anadama_bread_1.2e16d0ba.fill-500x500.jpg')} />
                                    <h3 className={styles.homeBreadCardTitle}>Anadama</h3>
                                </Link>
                                <Link to="/breads/anpam/" className={styles.homeBreadCard}>
                                    <img alt="" className={styles.homeBreadCardImage} src={getMediaUrl('/media/images/Bean-jam-bunanpankatori-cityjapan.2e16d0ba.fill-500x500.jpg')} />
                                    <h3 className={styles.homeBreadCardTitle}>Anpan</h3>
                                </Link>
                                <Link to="/breads/appam-hoppers/" className={styles.homeBreadCard}>
                                    <img alt="" className={styles.homeBreadCardImage} src={getMediaUrl('/media/images/Appam_served_with_Coconut_Milk_in_.2e16d0ba.fill-500x500.jpg')} />
                                    <h3 className={styles.homeBreadCardTitle}>Appam</h3>
                                </Link>
                                <Link to="/breads/arepa/" className={styles.homeBreadCard}>
                                    <img alt="" className={styles.homeBreadCardImage} src={getMediaUrl('/media/images/Arepa_asada.2e16d0ba.fill-500x500.jpg')} />
                            ...
                            <div className={styles.homeFeatures}>
                                <Link to="/locations/new-york/" className={styles.homeLocationCard}>
                                    <figure className={styles.homeLocationCardImageContainer}>
                                        <img alt="" className={styles.homeLocationCardImage} src={getMediaUrl('/media/images/hof-cornell-university-filter.df5c97ba.fill-430x210-c100.jpg')} />
                                    </figure>
                                ...
                                <Link to="/locations/reykjavik/" className={styles.homeLocationCard}>
                                    <figure className={styles.homeLocationCardImageContainer}>
                                        <img alt="" className={styles.homeLocationCardImage} src={getMediaUrl('/media/images/reykjavik-sverrir-thorolfsson.2e16d0ba.fill-430x210-c100.jpg')} />
                                    </figure>
                                    <div className={styles.homeLocationCardMeta}>
                                ...
                                <Link to="/locations/london/" className={styles.homeLocationCard}>
                                    <figure className={styles.homeLocationCardImageContainer}>
                                        <img alt="" className={styles.homeLocationCardImage} src={getMediaUrl('/media/images/vik.2e16d0ba.fill-430x210-c100.jpg')} />
                                    </figure>
                                    <div className={styles.homeLocationCardMeta}>
                            ...
                            <div className={styles.homeFeatures}>
                                <Link to="/blog/wild-yeast/" className={styles.homeBlogCard}>
                                    <figure className={styles.homeBlogCardImageContainer}>
                                        <img alt="" className={styles.homeBlogCardImage} src={getMediaUrl('/media/images/yeast.2e16d0ba.fill-430x254-c100.jpg')} />
                                    </figure>
                                ...
                                <Link to="/blog/bread-circuses/" className={styles.homeBlogCard}>
                                    <figure className={styles.homeBlogCardImageContainer}>
                                        <img alt="" className={styles.homeBlogCardImage} src={getMediaUrl('/media/images/Bedouins_making_bread.2e16d0ba.fill-430x254-c100.jpg')} />
                                    </figure>
                                ...
                                <Link to="/blog/icelandic-baking/" className={styles.homeBlogCard}>
                                    <figure className={styles.homeBlogCardImageContainer}>
                                        <img alt="" className={styles.homeBlogCardImage} src={getMediaUrl('/media/images/Olandshvedebrod_6082070226.2e16d0ba.fill-430x254-c100.jpg')} />
                                    </figure>
                                ...
                                <Link to="/blog/joy-baking-soda/" className={styles.homeBlogCard}>
                                    <figure className={styles.homeBlogCardImageContainer}>
                                        <img alt="" className={styles.homeBlogCardImage} src={getMediaUrl('/media/images/bakingsoda.2e16d0ba.fill-430x254-c100.jpg')} />
                                    </figure>
                                ...
                                <Link to="/blog/sliced-bread/" className={styles.homeBlogCard}>
                                    <figure className={styles.homeBlogCardImageContainer}>
                                        <img alt="" className={styles.homeBlogCardImage} src={getMediaUrl('/media/images/sliced.2e16d0ba.fill-430x254-c100.jpg')} />
                                    </figure>
                                ...
                                <Link to="/blog/desserts-benefits/" className={styles.homeBlogCard}>
                                    <figure className={styles.homeBlogCardImageContainer}>
                                        <img alt="" className={styles.homeBlogCardImage} src={getMediaUrl('/media/images/bostoncream.2e16d0ba.fill-430x254-c100.jpg')} />
                                    </figure>
